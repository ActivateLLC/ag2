---
sidebarTitle: SEOAuditAgent
title: autogen.seo_audit.SEOAuditAgent
---
<h2 id="autogen.seo_audit.SEOAuditAgent" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">SEOAuditAgent</span>
</h2>

```python
SEOAuditAgent(
    name: str,
    system_message: str | None = 'You are an expert SEO audit agent.\nYour role is to analyze technical SEO metrics, identify issues, and provide actionable recommendations.\nYou have access to various SEO APIs and can generate comprehensive audit reports.',
    llm_config: Dict[str, Any] | bool | None = None,
    **kwargs: Any
)
```

    Agent for performing technical SEO audits and generating reports.<br/>This agent interfaces with various SEO APIs to gather metrics and generate
    comprehensive technical SEO reports.<br/>Initialize the SEO Audit Agent.<br/>

<b>Parameters:</b>
| Name | Description |
|--|--|
| `name` | **Type:** str |
| `system_message` | **Type:** str \| None<br/><br/>**Default:** 'You are an expert SEO audit agent.\nYour role is to analyze technical SEO metrics, identify issues, and provide actionable recommendations.\nYou have access to various SEO APIs and can generate comprehensive audit reports.' |
...
```
    ...
    Run a technical SEO audit for the specified URL.<br/>

<b>Parameters:</b>
| Name | Description |
|--|--|
| `url` | The URL to audit<br/><br/>**Type:** str |
| `api_keys` | Dictionary of API keys for various services<br/><br/>**Type:** Dict[str, str] |
| `metrics` | List of specific metrics to check<br/><br/>**Type:** List[str] \| None<br/><br/>**Default:** None |

<b>Returns:</b>
| Type | Description |
|--|--|
| Dict[str, Any] | Dict[str, Any]: Audit results including: - Core Web Vitals - Mobile friendliness - Security issues - Crawlability - Schema markup validation - INP metrics |
