---
sidebarTitle: MarketingAutomationAgent
title: autogen.marketing_automation.MarketingAutomationAgent
---
<h2 id="autogen.marketing_automation.MarketingAutomationAgent" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">MarketingAutomationAgent</span>
</h2>

```python
MarketingAutomationAgent(
    name: str,
    system_message: str | None = 'You are an expert marketing automation agent.\nYour role is to manage and schedule marketing campaigns across various platforms,\noptimize posting schedules, and track campaign performance.',
    llm_config: Dict[str, Any] | bool | None = None,
    **kwargs: Any
)
```

    Agent for automating marketing tasks and campaign management.<br/>This agent interfaces with various marketing automation platforms to schedule
    and manage social media posts and marketing campaigns.<br/>Initialize the Marketing Automation Agent.<br/>

<b>Parameters:</b>
| Name | Description |
|--|--|
| `name` | **Type:** str |
| `system_message` | **Type:** str \| None<br/><br/>**Default:** 'You are an expert marketing automation agent.\nYour role is to manage and schedule marketing campaigns across various platforms,\noptimize posting schedules, and track campaign performance.' |
| `llm_config` | **Type:** Dict[str, Any] \| bool \| None<br/><br/>**Default:** None |
| `**kwargs` | **Type:** Any |
...
```
    ...
    Schedule a marketing campaign across various platforms.<br/>

<b>Parameters:</b>
| Name | Description |
|--|--|
| `campaign_config` | Campaign configuration including: - name: Campaign name - platforms: List of platforms to post on - content: List of content items to post - targeting: Audience targeting parameters - budget: Campaign budget information<br/><br/>**Type:** Dict[str, Any] |
| `platform_tokens` | API tokens for each platform<br/><br/>**Type:** Dict[str, str] |
| `schedule_start` | When to start scheduling posts<br/><br/>**Type:** datetime.datetime \| None<br/><br/>**Default:** None |

<b>Returns:</b>
| Type | Description |
|--|--|
| Dict[str, Any] | Dict[str, Any]: Results of scheduling operation including: - campaign_id: Unique ID for the campaign - scheduled_posts: List of scheduled posts - platforms: Platforms the campaign is scheduled for - start_time: When the campaign starts - end_time: When the campaign ends - status: Status of the scheduling operation |
