---
sidebarTitle: ABTestingAgent
title: autogen.marketing_ab_testing.ABTestingAgent
---
<h2 id="autogen.marketing_ab_testing.ABTestingAgent" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">ABTestingAgent</span>
</h2>

```python
ABTestingAgent(name: str | None = 'ab_testing_agent', **kwargs)
```

    Agent for managing A/B tests in marketing campaigns.<br/>Initialize the A/B Testing Agent.<br/>

<b>Parameters:</b>
| Name | Description |
|--|--|
| `name` | **Type:** str \| None<br/><br/>**Default:** 'ab_testing_agent' |
| `**kwargs` |  |
...
```python
analyze_results(self, test_id: str) -> Dict[str, Any]
```

    Analyze A/B test results and determine the winning variant.<br/>

<b>Parameters:</b>
| Name | Description |
|--|--|
| `test_id` | The A/B test identifier<br/><br/>**Type:** str |

<b>Returns:</b>
| Type | Description |
|--|--|
| Dict[str, Any] | Dictionary containing: - test_id: Test identifier - status: Analysis status - winning_variant: Winning variant details - metrics: Metric comparisons by variant - confidence_intervals: Statistical confidence intervals |
...
```
    ...
    Assign a user to a variant based on traffic allocation.<br/>

<b>Parameters:</b>
| Name | Description |
|--|--|
| `test_id` | The A/B test identifier<br/><br/>**Type:** str |
| `user_id` | Unique user identifier<br/><br/>**Type:** str |
| `context` | Optional context for sophisticated assignment<br/><br/>**Type:** Dict[str, Any] \| None<br/><br/>**Default:** None |

<b>Returns:</b>
| Type | Description |
|--|--|
| Dict[str, Any] | Dictionary containing: - variant_id: Assigned variant ID - assignment_time: Assignment timestamp - context: Assignment context |
...
```python
setup_experiment(self, test_config: Dict[str, Any]) -> Dict[str, Any]
```

    Set up an A/B test experiment.<br/>

<b>Parameters:</b>
| Name | Description |
|--|--|
| `test_config` | Dictionary containing test configuration: - name: Test name - variants: List of variant configurations - metrics: List of metrics to track - duration_days: Test duration in days - min_sample_size: Minimum sample size per variant - confidence_level: Statistical confidence level (default: 0.95)<br/><br/>**Type:** Dict[str, Any] |

<b>Returns:</b>
| Type | Description |
|--|--|
| Dict[str, Any] | Dictionary containing: - test_id: Unique test identifier - status: Setup status - variants: List of variant IDs and configurations - start_time: Test start time - end_time: Scheduled end time |
...
| `variant_id` | **Type:** str |
| `user_id` | **Type:** str |
| `metrics` | **Type:** Dict[str, Any] \| None |
